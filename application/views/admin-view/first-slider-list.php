                                ...
                                <table class="table table-striped table-bordered bootstap-datatable datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url() . 'admin/first_slider/edit_slider/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                                            <a href="<?php echo base_url() . 'admin/First_slider/delete_slide/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
