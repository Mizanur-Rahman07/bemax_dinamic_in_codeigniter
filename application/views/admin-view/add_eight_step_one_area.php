            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="image_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" name="textarea" id="textarea2" rows="3"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="f_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Facebook Icon Link </label>
                        <div class="controls">
                            <input type="text" name="f_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Twiter Icon </label>
                        <div class="controls">
                            <input type="text" name="twiter_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Twiter icon Link </label>
                        <div class="controls">
                            <input type="text" name="twiter_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Google icon </label>
                        <div class="controls">
                            <input type="text" name="google_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Google icon Link </label>
                        <div class="controls">
                            <input type="text" name="google_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> In icon </label>
                        <div class="controls">
                            <input type="text" name="in_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> In icon Link </label>
                        <div class="controls">
                            <input type="text" name="in_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
