            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2">Services Areatext</label>
                        <div class="controls">
                            <textarea class="cleditor" name="sub_heading" id="textarea2" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Icon </label>
                        <div class="controls">
                            <input type="text" name="icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
