                ...
                <table class="table table-striped table-bordered bootstap-datatable datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url() . 'admin/Fifth_services_area/edit_fifth_srvcs_area/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                            <a href="<?php echo base_url() . 'admin/Fifth_services_area/delete_svc_fifth/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
                        </tr>
                    <?php
                            }
