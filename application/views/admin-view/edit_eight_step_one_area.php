            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $image_link_from_db) ?>" name="image_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" value="<?php echo set_value('image', $textarea_from_db) ?>" name="textarea" id="textarea2" rows="3"><?php echo set_value('image', $textarea_from_db) ?></textarea>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Facebook Icon </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $f_icon_from_db) ?>" name="f_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Facebook Icon Link </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $f_icon_link_from_db) ?>" name="f_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Twiter Icon </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $twiter_icon_from_db) ?>" name="twiter_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Twiter icon Link </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $twiter_icon_link_from_db) ?>" name="twiter_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Google icon </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $google_icon_from_db) ?>" name="google_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Google icon Link </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $google_icon_link_from_db) ?>" name="google_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> In icon </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $in_icon_from_db) ?>" name="in_icon" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> In icon Link </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('image', $in_icon_link_from_db) ?>" name="in_icon_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
