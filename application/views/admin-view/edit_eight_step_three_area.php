            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" value="<?php echo set_value('address',$address_from_db);?>" name="address" id="textarea2" rows="3"><?php echo set_value('address',$address_from_db);?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('phone',$phone_from_db);?>" name="phone" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Fax </label>
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('fax',$fax_from_db);?>" name="fax" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo set_value('email',$email_from_db);?>" name="email" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
