				...
				<fieldset>
					<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="heading" value="<?php echo set_value('heading', $heading_from_db); ?>" class="span6 typeahead" id="typeahead">
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input class="input-file " name="slider_image"  id="fileInput" type="file">
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="button" value="<?php echo set_value('button', $button_from_db); ?>" class="span6 typeahead" id="typeahead">
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="button_link" value="<?php echo set_value('button_link', $button_link_from_db); ?>" class="span6 typeahead" id="typeahead">
							</div>
						</div>
