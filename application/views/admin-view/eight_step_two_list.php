                ...
                <table class="table table-striped table-bordered bootstap-datatable datatable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $value['step_one'] ?></td>
                            <td><?php echo $value['step_one_link'] ?></td>
                            <td><?php echo $value['step_two'] ?></td>
                            <td><?php echo $value['step_two_link'] ?></td>
                            <td><?php echo $value['step_three'] ?></td>
                            <td><?php echo $value['step_three_link'] ?></td>
                            <td><?php echo $value['step_four'] ?></td>
                            <td><?php echo $value['step_four_link'] ?></td>
                            <td><?php echo $value['step_five'] ?></td>
                            <td><?php echo $value['step_five_link'] ?></td>
                            <td><a href="<?php echo base_url() . 'admin/Eight_services_area/edit_step_two_area/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                            <a href="<?php echo base_url() . 'admin/Eight_services_area/delete_svc_step_two/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
                        </tr>
                    <?php
                            }
