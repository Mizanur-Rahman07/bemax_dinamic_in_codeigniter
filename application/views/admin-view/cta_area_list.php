                                ...
                                <table class="table table-striped table-bordered bootstap-datatable datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?>
                                        <tr>
                                            <td><?php echo $value['cta_textarea'] ?></td>
                                            <td><?php echo $value['cta_button'] ?></td>
                                            <td><?php echo $value['cta_button_link'] ?></td>
                                            <td><a href="<?php echo base_url() . 'admin/cta_area/edit_cta/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                                            <a href="<?php echo base_url() . 'admin/CTA_area/delete_cta/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
