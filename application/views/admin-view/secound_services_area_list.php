                ...
                <table class="table table-striped table-bordered bootstap-datatable datatable">
                    ...
                    <tbody>
                        ...
                        <td><?php echo $value['top_heading'] ?></td>
                            ...
                            <td><?php echo $value['icon_link'] ?></td>
                            <td><a href="<?php echo base_url() . 'admin/secound_services_area/edit_secound_srvcs_area/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                            <a href="<?php echo base_url() . 'admin/Secound_services_area/delete_svc_scnd/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
