                ...
                <table class="table table-striped table-bordered bootstap-datatable datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            ?>
                        <tr>
                            <td> <img src="<?php echo base_url('backend-dashboard-master/uploads/'.$value['image']) ?>" alt=""></td>
                            <td><?php echo $value['image_link'] ?></td>
                            <td><?php echo $value['textarea'] ?></td>
                            <td><?php echo $value['f_icon'] ?></td>
                            <td><?php echo $value['f_icon_link'] ?></td>
                            <td><?php echo $value['twiter_icon'] ?></td>
                            <td><?php echo $value['twiter_icon_link'] ?></td>
                            <td><?php echo $value['google_icon'] ?></td>
                            <td><?php echo $value['google_icon_link'] ?></td>
                            <td><?php echo $value['in_icon'] ?></td>
                            <td><?php echo $value['in_icon_link'] ?></td>
                            <td><a href="<?php echo base_url() . 'admin/Eight_services_area/edit_step_one_area/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                            <a href="<?php echo base_url() . 'admin/Eight_services_area/delete_svc_step_one/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
                        </tr>
                    <?php
                            }
