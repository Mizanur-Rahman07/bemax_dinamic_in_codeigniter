                ...
                <table class="table table-striped table-bordered bootstap-datatable datatable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            ?>
                        <tr>
                            <td><?php echo $value['top_heading'] ?></td>
                            <td><?php echo $value['heading'] ?></td>
                            <td><?php echo $value['heading_link'] ?></td>
                            ...
                            <td><?php echo $value['sub_heading_link'] ?></td>
                            <td><?php echo $value['plus'] ?></td>
                            <td><?php echo $value['plus_link'] ?></td>
                            <td><a href="<?php echo base_url() . 'admin/Sixth_services_area/edit_sixth_left_area/' . $value['id']; ?>" class="btn btn-info"><i class="halflings-icon white edit"></i></a>
                            <a href="<?php echo base_url() . 'admin/Sixth_services_area/delete_svc_six_left/' . $value['id']; ?>" class="btn btn-danger"><i class="halflings-icon white trash"></i></a></td>
                        </tr>
                    <?php
                            }
