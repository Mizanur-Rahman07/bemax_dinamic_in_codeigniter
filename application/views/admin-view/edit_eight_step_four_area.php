        ...
        <div class="box-content">
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> YourEmail </label>
                        <div class="controls">
                            <input type="text"  value="<?php echo set_value('youremail',$youremail_from_db);?>" name="youremail" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Button </label>
                        <div class="controls">
                            <input type="text"  value="<?php echo set_value('button',$button_from_db);?>" name="button" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"  value="<?php echo set_value('button_link',$button_link_from_db);?>" name="button_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
