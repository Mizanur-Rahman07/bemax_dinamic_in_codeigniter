            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2">CTA Textarea</label>
                        <div class="controls">
                         <textarea  class="cleditor" value="<?php echo set_value('cta_textarea',$cta_textarea_from_db); ?>" name="cta_textarea" id="textarea2" rows="3"><?php echo set_value('cta_textarea',$cta_textarea_from_db); ?></textarea>
                        </div>
                    </div>
                    
                        <div class="control-group">
                            <label class="control-label" for="typeahead"> Button </label>
                            <div class="controls">
                                <input type="text" value="<?php echo set_value('cta_button',$cta_button_from_db); ?>" name="cta_button" class="span6 typeahead" id="typeahead">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" value="<?php echo set_value('cta_button_link',$cta_button_link_from_db); ?>" name="cta_button_link" class="span6 typeahead" id="typeahead">
                            </div>
                        </div>
