            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="step_one" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 1 Link </label>
                        <div class="controls">
                            <input type="text" name="step_one_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 2 </label>
                        <div class="controls">
                            <input type="text" name="step_two" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 2 Link </label>
                        <div class="controls">
                            <input type="text" name="step_two_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 3 </label>
                        <div class="controls">
                            <input type="text" name="step_three" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 3 Link </label>
                        <div class="controls">
                            <input type="text" name="step_three_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 4 </label>
                        <div class="controls">
                            <input type="text" name="step_four" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 4 Link </label>
                        <div class="controls">
                            <input type="text" name="step_four_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 5 </label>
                        <div class="controls">
                            <input type="text" name="step_five" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="typeahead"> Step 5 Link </label>
                        <div class="controls">
                            <input type="text" name="step_five_link" class="span6 typeahead" id="typeahead">
                        </div>
                    </div>
